 ...
 * 获得请求信息
 *
 * @author Kevin KDA on 2020/10/13 15:29
 * @version 1.0.0
 * @project maven-open-project
 * @package com.kevinkda.core.util.web.servlet.request
 * @classname RequestService
 * @apiNote <p>v1.1.0 Modify by Kevin KDA on 2020/5/11 21:50，更新获取全部请求数据的方法，
 * 加入新的获得请求体数据方法、获得参数String数组和打印参数的方法</p>
 * @since 1.0.0
 */
@Service
...
//    处理Text形式的数据
     ...
     * @description RequestService / getParametersForText
     * @version 1.0.0
...
//                        加入请求体Map
     ...
     * @description RequestService / getRequestHead
     * @version 1.0.0
     * @apiNote <p></p>
     * @since 3.0.5
     */
...
//        返回所有请求头信息
     ...
     * @description RequestService / getRequestBody
     * @version 1.0.0
     * @apiNote <p></p>
     * @since 3.1.2
     */
...
//        返回所有请求头信息
     ...
     * @description RequestService / printParameters
     * @version 1.0.0
     * @apiNote <p></p>
     * @since 3.1.2
     */
...
//        set.stream().map(entry -> entry.getKey() + ":" + entry.getValue()).forEach(System.out::println);
     ...
     * @author Kevin KDA on 2020/5/11 22:15
     * @description RequestService / showParameters
     * @version 1.0.0
     * @apiNote <p></p>
     * @since 3.1.2
     */
...
//        (String[]) set.stream().map(entry -> entry.getKey() + ":" + entry.getValue()).toArray();
     ...
     * @description RequestService / getPostBody
     * @version 1.0.0
     * @apiNote <p></p>
     * @since 3.0.5
     */
